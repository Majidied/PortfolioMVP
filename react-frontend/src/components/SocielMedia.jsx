      ...
      <section className='flex justify-around items-center'>
        <section className="flex justify-center items-center mr-4">
          ...
          >
            ...
            <span className="absolute opacity-0 group-hover:opacity-100 group-hover:text-gray-50 group-hover:text-sm group-hover:-translate-y-10 duration-700">
              GitHub
            </span>
          </a>
        </section>
        ...
        <section className="flex justify-center items-center mr-4">          <a
